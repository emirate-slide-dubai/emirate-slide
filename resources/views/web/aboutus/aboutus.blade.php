        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="challange_text_inner">
                    ...
                    <div class="c_video">
                        <a class="popup-youtube" href="https://www.youtube.com/watch?v=62QYQE6k7tg"><img src="{{ asset('web_asset/img/icon/video-icon.png') }}" alt="">See how we work </a>
                    </div>
                </div>
            </div>
            <div class="col-lg-6 challange_img">
                <div class="challange_img_inner">
                    <img class="img-fluid" src="{{ asset('web_asset/img/popup-photo.jpg') }}" alt="">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="testimonials_slider owl-carousel">
            <div class="item">
                <div class="testi_item">
                    ...
                    <div class="media">
                        <div class="d-flex">
                            <img class="rounded-circle" src="{{ asset('web_asset/img/testimonials/testi-1.jpg') }}" alt="">
                        </div>
            ...
            <div class="item">
                <div class="testi_item">
                    ...
                    <div class="media">
                        <div class="d-flex">
                            <img class="rounded-circle" src="{{ asset('web_asset/img/testimonials/testi-2.jpg') }}" alt="">
                        </div>
                        <div class="media-body">
                            <h4>Chriss Turner</h4>
                            <h5>CEO Enterprise</h5>
            ...
            <div class="item">
                <div class="testi_item">
                    ...
                    <div class="media">
                        <div class="d-flex">
                            <img class="rounded-circle" src="{{ asset('web_asset/img/testimonials/testi-3.jpg') }}" alt="">
                        </div>
                        <div class="media-body">
                            <h4>Julie Smart</h4>
                            <h5>CEO Enterprise</h5>
...
<section class="talk_area">
    <div class="container">
        <div class="talk_text">
            ...
            <a href="">contact@sierracompany.com</a>
        </div>
    </div>
</section>
<!--================End We Are Company Area =================-->
