                ...
                <div class="col-lg-12">
                    <div class="single_blog_inner">
                        ...
                        <div class="blog_author">
                            <div class="media">
                                <div class="d-flex">
                                    <img class="rounded-circle" src="{{ asset('web_asset/img/blog/blog-author.png') }}" alt="">
                                </div>
                        ...
                        <div class="blog_comment">
                            <h3>Comments (2)</h3>
                            <div class="media">
                                <img src="{{ asset('web_asset/img/comment/comment-1.png') }}" alt="">
                                <div class="d-flex">
                            ...
                            <div class="media">
                                <img src="{{ asset('web_asset/img/comment/comment-2.png') }}" alt="">
                                <div class="d-flex">
                                    <h4>Gabriel Smith</h4>
                                    <h5>Oct 29, 2017</h5>
                                </div>
