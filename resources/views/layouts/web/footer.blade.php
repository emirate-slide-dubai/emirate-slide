            ...
            <div class="row footer_widget_inner">
                <div class="col-lg-4 col-sm-6">
                    <aside class="f_widget f_about_widget">
                        <img src="{{ asset('web_asset/img/footer-logo.png') }}" alt="">
                ...
                <div class="col-lg-4 col-sm-6">
                    <aside class="f_widget f_insta_widget">
                        ...
                        <ul>
                            <li><a href="#"><img src="{{ asset('web_asset/img/instagram/ins-1.jpg') }}"
                                        alt=""></a></li>
                            <li><a href="#"><img src="{{ asset('web_asset/img/instagram/ins-2.jpg') }}"
                                        alt=""></a></li>
                            <li><a href="#"><img src="{{ asset('web_asset/img/instagram/ins-3.jpg') }}"
                                        alt=""></a></li>
                            <li><a href="#"><img src="{{ asset('web_asset/img/instagram/ins-4.jpg') }}"
                                        alt=""></a></li>
                            <li><a href="#"><img src="{{ asset('web_asset/img/instagram/ins-5.jpg') }}"
                                        alt=""></a></li>
                            <li><a href="#"><img src="{{ asset('web_asset/img/instagram/ins-6.jpg') }}"
                                        alt=""></a></li>
                            <li><a href="#"><img src="{{ asset('web_asset/img/instagram/ins-7.jpg') }}"
                                        alt=""></a></li>
                            <li><a href="#"><img src="{{ asset('web_asset/img/instagram/ins-8.jpg') }}"
                                        alt=""></a></li>
                        </ul>
                    </aside>
                </div>
